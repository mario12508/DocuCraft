# Generated by Django 5.2.7 on 2026-09-12 12:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('system', 'Системный'), ('user', 'Пользовательский')], default='system', max_length=20, verbose_name='Тип шаблона')),
                ('code', models.SlugField(unique=True, verbose_name='Код')),
                ('name', models.CharField(max_length=100, verbose_name='Название')),
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('rules', models.JSONField(default=dict, verbose_name='Правила оформления')),
                ('docx_template', models.FileField(blank=True, upload_to='templates/', verbose_name='Файл-шаблон DOCX')),
                ('placeholders', models.JSONField(blank=True, default=list, help_text='Заполняется автоматически при загрузке файла.', verbose_name='Плейсхолдеры')),
                ('parse_status', models.CharField(choices=[('pending', 'Ожидает'), ('processing', 'В обработке'), ('ready', 'Готов'), ('error', 'Ошибка')], default='ready', max_length=20, verbose_name='Статус парсинга')),
                ('parse_error', models.TextField(blank=True, verbose_name='Ошибка парсинга')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активен')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Обновлён')),
                ('owner', models.ForeignKey(blank=True, help_text='Пусто — системный шаблон, доступен всем.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='document_templates', to=settings.AUTH_USER_MODEL, verbose_name='Владелец')),
            ],
            options={
                'verbose_name': 'Шаблон',
        ...
        migrations.AddConstraint(
            model_name='template',
            constraint=models.UniqueConstraint(fields=('owner', 'code'), name='unique_template_code_per_owner'),
        ),
    ]
