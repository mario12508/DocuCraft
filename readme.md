...
Через административную панель → «Шаблоны»:

1. Укажите `code`, `name`, `description`.
2. Заполните `rules` — JSON с правилами оформления:
...
Шаблон сразу становится доступен на Шаге 2 — переписывать код не нужно.
